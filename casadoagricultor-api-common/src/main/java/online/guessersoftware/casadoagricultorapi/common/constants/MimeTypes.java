...
public class MimeTypes {
	...
	private static Logger log = LogManager.getLogger(MimeTypes.class);

	private static Tika tika = new Tika();

	public static String getMimeType(String format) {
		return tika.detect("test." + format);
	}

	public static String lookupFormat(String mimeType) {
		try {
			String ext = org.apache.tika.mime.MimeTypes.getDefaultMimeTypes().forName(mimeType).getExtension();
			return StringUtils.replace(ext, ".", "");
		} catch (MimeTypeException e) {
			log.warn("Couldnt find mimeType=" + mimeType + " into Tika library, returning pdf");
			return "pdf";
		}
	}

	// SOME MIMES CONSTANTS

	public static final String MIME_APPLICATION_ANDROID = "application/vnd.android.package-archive";
	...
	public static final String MIME_APPLICATION_VND_MSEXCEL_X = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
